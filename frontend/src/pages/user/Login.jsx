...
const Login = () => {
    useTitle('Login | TrimTrack - Be Bold');
    ...
    return (
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <p className="mx-auto mt-4 max-w-md text-center text-gray-500">Explore our luxury services, meticulously crafted to cater to all levels of expertise.</p>

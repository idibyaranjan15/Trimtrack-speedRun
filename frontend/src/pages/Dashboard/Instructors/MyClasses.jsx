...
const MyClasses = () => {
    ...
    return (
        <div>
            <div className="my-9">
                <h1 className='text-4xl font-bold text-center '>My <span className='text-secondary'>Services</span></h1>
                <div className="text-center">

                    <Fade duration={100} className='text-[12px]  text-center' cascade>Here you can see how many services added by you and all services status</Fade>
                </div>


                <div className="">
                    {
                        classes.length === 0 ? <div className='text-center text-2xl font-bold mt-10'>You have not added any service yet</div> :
                            <div className="mt-9">
                                {
                                            ...
                                            <div className="w-full">
                                                ...
                                                <div className="flex gap-5">
                                                    <div className="">
                                                        ...
                                                        <h1 className='text-secondary my-2'><span className='text-black '>Total clients</span> : {cls.totalEnrolled ? cls.totalEnrolled : 0}</h1>

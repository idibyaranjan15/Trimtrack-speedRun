...
const adminNavItems = [
    ...
    { to: "/dashboard/manage-class", icon: <BsFillPostcardFill className="text-2xl" />, label: "Manage Service" },
...
const instructorNavItem = [
    ...
    { to: "/dashboard/add-class", icon: <MdExplore className="text-2xl" />, label: "Add A Service" },
    { to: "/dashboard/my-classes", icon: <IoSchoolSharp className="text-2xl" />, label: "My Services" },
    { to: "/dashboard/my-pending", icon: <MdPendingActions className="text-2xl" />, label: "Pending " },
    { to: "/dashboard/my-approved", icon: <IoMdDoneAll className="text-2xl" />, label: "Approved Services" },
];
const student = [
    ...
    { to: "/dashboard/apply-instructor", icon: <SiInstructure className="text-2xl" />, label: "Apply for Salon" },
];
const lastMenuItems = [
